      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative order-first lg:order-last">
            ...
            {/* Floating badge */}
            <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl p-6 shadow-xl border border-[#D5DEEF]/50">
              <div className="text-center">
                <div className="text-4xl font-bold text-[#395886] mb-1">4</div>
                <div className="text-sm text-gray-600">Tipos de<br/>Aparelhos</div>
              </div>
            </div>
          </div>
        </div>
